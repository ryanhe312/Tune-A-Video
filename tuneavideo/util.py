...
class NullInversion:
    ...
    def __init__(self, model, ddim_steps = 10, guidance_scale=7.5):
    ...
    def null_optimization(self, latents, num_inner_steps, epsilon):
        ...
        for i in range(self.NUM_DDIM_STEPS):
            ...
            for j in range(num_inner_steps):
                ...
                bar.set_postfix(inv_loss=f"{loss.item():.8f}")
                loss.backward()
                optimizer.step()
                optimizer.zero_grad()
                loss_item = loss.item()
    ...
    def invert(self, latent, prompt: str, offsets=(0,0,0,0), num_inner_steps=10, early_stop_epsilon=1e-5, verbose=False):
